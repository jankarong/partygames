...
const translations = {
    ...
    messages: {
        'Drag bottles to swap positions, or click to select:': 'Seret botol için menukar posisi, atau klik için memilih:',
        'Click a color to select:': 'Klik warna için memilih:',
        'Please complete your guess sequence!': 'Silakan lengkapi urutan tebakan Anda!',
        'Congratulations!': 'Selamat!',
        'Guess Feedback': 'Umpan Balik Tebakan',
        'Correct position and color:': 'Posisi ve warna olan benar:',
