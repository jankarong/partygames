...
function rollDice() {
    ...
    actionDice.querySelector('.dice-text').textContent = 'Donuyor...';
    whereDice.querySelector('.dice-text').textContent = 'Donuyor...';
    timeDice.querySelector('.dice-text').textContent = 'Donuyor...';
    ...
    setTimeout(() => {
        ...
        // Show result
        resultDiv.textContent = `${action} ${where} - ${time}`;
...
function addOption(type) {
    ...
    const defaultValue = type === 'time' ? '30 saniye' : 'Yeni Secenek';
