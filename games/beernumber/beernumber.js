document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleGuess() {
        ...
        if (guess === targetNumber) {
            message.textContent = `Cheers! 🍻 You found the number ${targetNumber} in ${guesses.length} tries!`;
        ...
        // Provide hint if guess is too low
            ...
            message.textContent = 'Too low! Your beer needs more filling! 🍺';
            message.className = 'alert alert-warning';
        }
        // Provide hint if guess is too high
        else {
            message.textContent = 'Too high! You\'re overflowing the mug! 🍺';
            message.className = 'alert alert-warning';
        }
