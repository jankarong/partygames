...
const WORDS = [
    ...
    "Will Smith", "Tom Hanks", "Meryl Streep", "Denzel Washington", "Morgan Freeman",
    ...
    "David Beckham", "Cristiano Ronaldo", "Lionel Messi", "Usain Bolt", "Michael Jordan",
    ...
    // Professions (60)
    "Doctor", "Teacher", "Chef", "Police Officer", "Firefighter", "Pilot", "Nurse", "Astronaut", "Artist", "Musician",
    "Lawyer", "Judge", "Accountant", "Engineer", "Architect", "Electrician", "Plumber", "Carpenter", "Mechanic", "Farmer",
    ...
    "Meditation", "Breathing", "Thinking", "Dreaming", "Laughing", "Crying", "Smiling", "Frowning", "Talking", "Listening",
    ...
    "Dumbo", "Bambi", "Jungle Book", "Aladdin", "Mulan", "Pocahontas", "Hercules", "Hunchback of Notre Dame", "Tarzan", "Little Mermaid",
    ...
    "Dexter", "The Sopranos", "Mad Men", "Downton Abbey", "Peaky Blinders", "Ozark", "Bodyguard", "Line of Duty",
    ...
    // Countries (60)
    "France", "Japan", "Egypt", "Brazil", "Canada", "Australia", "India", "Germany", "Mexico", "Italy",
    ...
    "Rain", "Snow", "Ice", "Wind", "Cloud", "Sun", "Moon", "Star", "Meteor", "Comet",
    ...
    "Chemistry", "Biology", "Literature", "Philosophy", "Psychology", "Sociology", "Economics", "Business", "Law", "Medicine",
    ...
    "Jump", "Skip", "Hop", "Crawl", "Climb", "Slide", "Swing", "Roll", "Spin", "Twist",
    ...
    // Bathroom (20)
    "Toilet", "Bathtub", "Shower", "Sink", "Faucet", "Mirror", "Medicine Cabinet", "Towel Rack", "Soap Dispenser", "Toothbrush Holder",
    ...
    "Good", "Bad", "Right", "Wrong", "True", "False", "New", "Old", "Young", "Ancient",
