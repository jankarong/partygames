...
class KingsCupGame {
    constructor() {
        ...
        this.cardRules = {
            'A': {
                ...
                action: '🌊 Start the waterfall! Everyone drinks continuously until the person before you stops!'
            },
            '2': {
                name: 'You',
            ...
            '3': {
                name: 'Me',
                description: 'You drink! The person who drew this card must take a sip.',
                action: '🍻 You drink! Take a sip yourself!'
            },
            '4': {
                name: 'Floor',
            ...
            '6': {
                name: 'Girls',
                description: 'All girls drink together. Every female player takes a sip at the same time.',
                action: '👧 All girls drink together! Ladies take a sip!'
            },
            '7': {
                name: 'Heaven',
            ...
            'Q': {
                name: 'Questions',
                description: 'You can only ask questions to other players. Anyone who answers (instead of asking back) drinks. This continues until someone else draws a Queen.',
                action: '❓ You can only ask questions! Anyone who answers (instead of asking back) drinks!'
            },
            'K': {
                name: 'Kings Cup',
                description: 'Pour some of your drink into the Kings Cup in the center. If this is the 4th King, you must drink the entire Kings Cup and the game ends!',
                action: '👑 Pour your drink into the Kings Cup! This is the {kingNumber} King!'
            }
        };
    ...
    updateCardContent(card) {
        ...
        if (card.value === 'K') {
            if (this.kingsDrawn === 4) {
                actionDescription = 'Fourth King! You must drink the entire Kings Cup! Game Over! 🍻';
            } else {
                actionDescription = `Pour your drink into the Kings Cup! This is the ${this.getOrdinal(this.kingsDrawn)} King!`;
            }
        }
    ...
    showGameOver() {
        ...
        ruleText.innerHTML = `
            ...
            🏆 The final King must drink the Kings Cup!<br>
            🎊 Thanks for playing!
        `;
    ...
    resetGame() {
        ...
        ruleName.textContent = 'Draw Card';
        ruleText.textContent = 'Click to draw your first card!';
