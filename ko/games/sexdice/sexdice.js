...
function rollDice() {
    ...
    actionDice.querySelector('.dice-text').textContent = '굴리는 중...';
    whereDice.querySelector('.dice-text').textContent = '굴리는 중...';
    timeDice.querySelector('.dice-text').textContent = '굴리는 중...';
    ...
    setTimeout(() => {
        ...
        // Show result
        resultDiv.textContent = `${where} 부위를 ${time} ${action}`;
...
function addOption(type) {
    ...
    const defaultValue = type === 'time' ? '30초 동안' : '새 항목';
