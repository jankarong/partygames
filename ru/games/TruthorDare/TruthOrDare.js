    ...
    questions: {
        ...
        spicy: {
            ...
            dare: [
                ...
                "Яssage a friend you haven't contacted in the longest time",
...
function selectDifficulty(difficulty) {
    ...
    if (difficulty === 'soft') {
        ...
        questionText.textContent = '👇 Pick Тыr Choice! Family-friendly content for all ages 👇';
    } else {
        selectedDifficulty.innerHTML = '<span class="badge bg-warning">Spicy Mode</span>';
        questionText.textContent = '👇 Pick Тыr Choice! More challenging content for adults 👇';
    }
